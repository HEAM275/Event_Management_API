...
from modules.events.serializers.event_serializers import (
    EventListSerializer,
...
class EventViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        operation_description="List all active events.",
        manual_parameters=[
            oa.Parameter(
                name="Authorization",
                in_=oa.IN_HEADER,
        ...
        responses={
            200: oa.Response(
                description="List of events", schema=EventListSerializer(many=True)
            ),
            403: oa.Response(
    ...
    @swagger_auto_schema(
        operation_description="Retrieve a specific event.",
        manual_parameters=[
            oa.Parameter(
                name="Authorization",
                in_=oa.IN_HEADER,
        ...
        responses={
            200: oa.Response(description="Event details", schema=EventDetailSerializer),
            403: oa.Response(
                description="Forbidden",
                schema=oa.Schema(
                    type=oa.TYPE_OBJECT,
    ...
    @swagger_auto_schema(
        ...
        responses={
            201: oa.Response(
                description="Event created successfully", schema=EventListSerializer
            ),
            400: oa.Response(
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response(
            {"message": _("Event could not be created"),
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: oa.Response(
                description="Event updated successfully", schema=EventListSerializer
            ),
            400: oa.Response(
                description="Bad request",
                schema=oa.Schema(
    ...
    def update(self, request, *args, **kwargs):
        ...
        return Response(
            {"message": _("Event could not be updated"),
             "error": serializer.errors},
            status=status.HTTP_400_BAD_REQUEST,
        )

    @swagger_auto_schema(
        operation_description="Delete an event (soft delete: is_active=False).",
        manual_parameters=[
            oa.Parameter(
                name="Authorization",
                in_=oa.IN_HEADER,
    ...
    def destroy(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"message": _("Event could not be deleted"), "error": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
